...
open class AmplifyCloudFormationImportExtension @Inject constructor(
    ...
    val cdkOutputsFile: Property<File>
    ...
    init {
        ...
        this.cdkOutputsFile = objectFactory.property(File::class.java)
    ...
    fun setCdkOutputsFile(file: File) {
        this.cdkOutputsFile(file)
    }

    fun cdkOutputsFile(file: File) {
        this.cdkOutputsFile.set(file)
    }
